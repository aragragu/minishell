...
#    Updated: 2024/10/28 15:50:54 by ykasmi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =	parsing/token.c parsing/token2.c parsing/token3.c parsing/token4.c parsing/main.c parsing/split.c parsing/libft.c \
		parsing/libft2.c parsing/libft3.c parsing/libft4.c parsing/libft5.c parsing/libft6.c parsing/signals.c parsing/expanding5.c \
